...
public class SecureItemTableTest {
    ...
    @BeforeClass public static void setUpClass() {
        item1 = new SecureItem().setTitle("Ponybook").setUsername("Applejack");
        item2 = new SecureItem().setTitle("Trotter").setUsername("Rarity");
        item3 = new SecureItem().setTitle("Instagrass").setUsername("Fluttershy");
    }
